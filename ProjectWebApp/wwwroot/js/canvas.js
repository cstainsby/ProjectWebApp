...
// these functions are all boiler plate code in order to set up 
...
function main() {
    ...
    if (!gl) {
        alert("Unable to initialize WebGL, your browser likley doesnt support webgl.");
        return;
    }
    ...
    // initilize new shader programs with the new variable shaderProgram
